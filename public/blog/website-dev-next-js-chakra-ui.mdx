...
I found integrating MDX documents that supported both latex and components to be a headache to figure out, so I wanted to write out what I had found. I found [this article](https://dev.to/tylerlwsmith/quick-comparison-of-mdx-integration-strategies-with-next-js-1kcm) by Tyler Smith to be super helpful. After testing, I found
